...
export function PlatformLogoHeader({ className = "", homeHref = "/" }: PlatformLogoHeaderProps) {
  return (
    <Link
      ...
      className={`inline-flex min-h-16 shrink-0 items-center rounded-2xl bg-white px-2 py-1 shadow-sm ring-1 ring-slate-200 transition hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-[#E4007C] sm:min-h-20 ${className}`}
    >
      <Image
