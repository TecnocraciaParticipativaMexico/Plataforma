  ...
  return (
    <section className="rounded-[24px] bg-white p-5 shadow-sm ring-1 ring-[#F7C9DD]">
      <div className="mb-3 inline-flex rounded-full bg-[#EADCFF] px-3 py-1 text-xs font-bold uppercase text-[#4B238D]">
        Comités ciudadanos mock
      </div>
      <h2 className="text-xl font-bold text-[#0A4E84]">Revisión cívica futura por niveles</h2>
      ...
      <p className="mt-2 rounded-2xl bg-[#FFF8F0] p-4 text-sm leading-6 text-slate-700">
