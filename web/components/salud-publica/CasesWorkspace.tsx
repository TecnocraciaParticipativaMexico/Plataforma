    ...
    <div className="grid gap-5 xl:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)]">
      <section className="space-y-4 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
        ...
        <div className="grid gap-3">
          ...
          <UiState kind="vacio" title="Estado vacio">Cuando no existan expedientes se mostrara una invitacion a crear borrador.</UiState>
        </div>
      </section>
    ...
    <section className="space-y-4">
      ...
      {selectedCase.attentionLevel === "posible_emergencia" || latestGuidance?.level === "posible_emergencia" ? (
        <section className="rounded-2xl border-l-4 border-[#E4007C] bg-[#FDF2F8] p-4 text-sm leading-6 text-[#9D174D]">
          <h3 className="font-black uppercase">Posible senal de alarma</h3>
          <p>{URGENT_NOTICE}</p>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        {[
          ["Sintomas declarados", selectedCase.symptoms, "ciudadano"],
      ...
      <article className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
        <div className="flex items-center justify-between gap-3">
          <h3 className="font-black text-[#0A4E84]">Orientacion, acciones y notas</h3>
        ...
        {latestGuidance ? (
          ...
          <UiState kind="proveedor_no_disponible" title="Sin orientacion generada">Puedes usar el asistente local para estructurar una orientacion informativa.</UiState>
        )}
      </article>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <article className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
          <h3 className="font-black text-[#0A4E84]">Documentos, versiones y auditoria</h3>
          ...
          <UiState kind="advertencia" title="Privacidad">Controles simulados: ocultar informacion sensible, cambiar alias, exportar y eliminar expediente.</UiState>
        </article>
      </div>
    </section>
  );
